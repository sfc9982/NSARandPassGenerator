 ...
 * their values in a variety of formats. It can also generate a "usage" listing
 * of options.
 *
 * @author nziring
 */
...
public class OptionManager {
	 ...
	 */
	public void addOption(String name, String desc, boolean needsArg, String opt, String def) {
	...
	/**
	 * Generate a "usage" message text of the available options and return it as a
	 * big, multi-line string. Must be done after all the addOption calls.
	 */
	...
	/**
	 * Retrieve a value that was parsed from the command line, null if the option
	 * wasn't given and has no default. (This function returns the string value,
	 * other methods will parse as boolean or integer or float.)
	 *
	 ...
	 * @return integer value parse from string value of the option, or -1 if the
	 *         option was not supplied and there is no default
	 */
	...
	/**
	 * Parse an array of command-line args into the values array. Returns 0 on
	 * success, error count if any options unrecognized or required arguments
	 * missing.
	 *

...
public interface EntropySource extends SelfTestable {
	/**
	 * Get requested entropy. This method appends the entropy into the provided
	...
	/**
	 * Return entropy gathered during self-test, if any. Implementations may simply
	 * return null, if the entropy gathered during self-test is no longer available
	 * or is not valid. This method must not throw any exceptions; if self-test
	 * failed then this method must return null. If called multiple times, this
	 * method should return the same value, until the next time a self-test is
	...
	/**
	 * Release any necessary resources that this EntropySource might have opened.
	 * Implementations of this method must not throw any exceptions, and must be
